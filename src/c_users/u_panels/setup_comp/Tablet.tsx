    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <div className={`${p.edit ? 'flex' : 'hidden'} flex-col gap-2`}>
                ...
                <div>Size:</div>
                <div className="join">
                    <input onChange={(e) => p.edit && p.setTablet((pr) => ({ ...pr, size: { w: parseInt(e.target.value), h: pr.size.h } }))}
                    ...
                    <input onChange={(e) => p.edit && p.setTablet((pr) => ({ ...pr, size: { w: pr.size.w, h: parseInt(e.target.value) } }))}
                ...
                <div>Area:</div>
                <div className="join">
                    <input onChange={(e) => p.edit && p.setTablet((pr) => ({ ...pr, area: { w: parseInt(e.target.value), h: pr.area.h } }))}
                    ...
                    <div className="join-item input input-sm input-bordered">x</div>
                    <input onChange={(e) => p.edit && p.setTablet((pr) => ({ ...pr, area: { w: pr.area.w, h: parseInt(e.target.value) } }))}
                ...
                <div>Position:</div>
                <div className="join">
                    <input onChange={(e) => p.edit && p.setTablet((pr) => ({ ...pr, position: { x: parseInt(e.target.value), y: pr.position.y, r: pr.position.r } }))}
                    ...
                    <div className="join-item input input-sm input-bordered">x</div>
                    <input onChange={(e) => p.edit && p.setTablet((pr) => ({ ...pr, position: { x: pr.position.x, y: parseInt(e.target.value), r: pr.position.r } }))}
                    ...
                    <div className="join-item input input-sm input-bordered">mm</div>
                    <input onChange={(e) => p.edit && p.setTablet((pr) => ({ ...pr, position: { x: pr.position.x, y: pr.position.y, r: parseInt(e.target.value) } }))}
